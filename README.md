...
Serial XMODEM send/receive utility.
...
You should have received a copy of the GNU General Public License along with this program. If not, see the `LICENSE` file in this repository.
